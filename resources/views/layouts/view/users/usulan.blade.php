                    ...
                    <div class="invoice p-3 mb-3">
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        {{-- delete users --}}
                                                        <form id="usulan-anggaran-{{ $item->id }}" action="{{ route('users.delete-usulan', $item->id) }}" method="POST">
                                                            @csrf
                                                            @method('delete')
                                                            <button onclick="event.preventDefault(); deleteUsulanAnggaran('{{ $item->id }}')" class="dropdown-item activeBtn" type="submit">Delete</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </td>
                        ...
                        <div class="row no-print">
                            <div class="col-12">
                                ...
                                <form action="{{ route('users.submit-anggaran', ['anggaran' => $countUsulan, 'nama' => $photos['nama_lengkap'], 'photo' => $photos['photos']]) }}" , method="POST">
                                    @csrf
                                ...
                                @if ($statusUsulan['status'] == 'diterima')
                                <a href="{{ route('users.cetak-usulan') }}" rel="noopener" class="btn btn-default"><i class="fas fa-print"></i> Cetak</a>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_barang')
                                is-invalid
                            @enderror" name="nama_barang" id="nama_barang" placeholder="Masukan nama barang" value="{{ old('nama_barang') }}">
                            @error('nama_barang')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('volume')
                                is-invalid
                            @enderror" name="volume" id="volume" placeholder="Masukan volume" value="{{ old('volume') }}">
                            @error('volume')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('harga_satuan')
                                is-invalid
                            @enderror" name="harga_satuan" id="harga_satuan" placeholder="Masukan harga satuan" value="{{ old('harga_satuan') }}">
                            @error('harga_satuan')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('satuan')
                                is-invalid
                            @enderror" name="satuan" id="satuan" placeholder="Masukan satuan" value="{{ old('satuan') }}">
                            @error('satuan')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
