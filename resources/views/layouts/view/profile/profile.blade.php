                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle" src="{{ url('photo_profile', $data_profile['photos']) }}" alt="User profile picture">
                            </div>
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="active tab-pane" id="activity">
                                    ...
                                    <div class="post">
                                        <div class="user-block">
                                            <img class="img-circle img-bordered-sm" src="{{ url('photo_profile', $a->photo) }}" alt="user image">
                                            <span class="username">
                                                <a href="#">{{ $a->nama }}</a>
                                            </span>
                                    ...
                                    <div class="timeline timeline-inverse">
                                        ...
                                        <div>
                                            ...
                                            <div class="timeline-item">
                                                ...
                                                <div class="timeline-footer">
                                                    <a href="#" class="btn btn-success btn-sm">{{ $u->status }}</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="timeline-item">
                                                ...
                                                <div class="timeline-footer">
                                                    <a href="#" class="btn btn-danger btn-sm">{{ $u->status }}</a>
                                                </div>
                                            </div>
                                        </div>
                                        @else
                                        ...
                                        <div>
                                            ...
                                            <div class="timeline-item">
                                                ...
                                                <h3 class="timeline-header border-0"><a href="#">{{ $data_profile['nama_lengkap'] }}</a>
                                                    {{ $u->status }}
                                                </h3>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane" id="settings">
                                    <form class="form-horizontal" action="{{ route('profile.submit') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control @error('nama_lengkap')
                                                        'is-invalid'
                                                    @enderror" id="inputName" placeholder="Name" name="nama_lengkap" value="{{ $data_profile['nama_lengkap'] }}">
                                                @error('nama_lengkap')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control  @error('username')
                                                    'is-invalid'
                                                @enderror" id="inputEmail" placeholder="Username" name="username" value="{{ Auth::user()->username }}">
                                                @error('username')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control  @error('education')
                                                    'is-invalid'
                                                @enderror" id="inputEmail" placeholder="education" name="education" value="{{ $data_profile['education'] }}">
                                                @error('education')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control  @error('location')
                                                    'is-invalid'
                                                @enderror" id="inputEmail" placeholder="location" name="location" value="{{ $data_profile['location'] }}">
                                                @error('location')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control  @error('skill')
                                                    'is-invalid'
                                                @enderror" id="inputEmail" placeholder="skill" name="skill" value="{{ $data_profile['skill'] }}">
                                                @error('skill')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control  @error('about_me')
                                                    'is-invalid'
                                                @enderror" id="inputEmail" placeholder="about_me" name="about_me" value="{{ $data_profile['about_me'] }}">
                                                @error('about_me')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="password" class="form-control  @error('password')
                                                    'is-invalid'
                                                @enderror" id="inputName2" name="password" placeholder="Password">
                                                @error('password')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="password" class="form-control  @error('password-confirmation')
                                                    'is-invalid'
                                                @enderror" id="inputName2" name="password-confirmation" placeholder="Password Confirmation">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input @error('photos') is-invalid @enderror" name="photos" id="exampleInputFile">
