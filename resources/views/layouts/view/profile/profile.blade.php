                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="settings">
                                    <form class="form-horizontal" action="{{ route('profile.submit') }}" method="POST">
                                        @csrf
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control @error('name')
                                                        'is-invalid'
                                                    @enderror" id="inputName" placeholder="Name" name="name"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control  @error('username')
                                                    'is-invalid'
                                                @enderror" id="inputEmail" placeholder="Username" name="username"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="password" class="form-control  @error('password-confirmation')
                                                    'is-invalid'
                                                @enderror" id="inputName2" name="password-confirmation"
