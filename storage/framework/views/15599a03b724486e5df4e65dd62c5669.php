<?php $__env->startSection('title', 'Registrasi Akun'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <img src="<?php echo e(asset('assets/img/logoSIPPWarna.png')); ?>" width="50%">

                <div class="card">
                    <div class="card-header"><?php echo e(__('Register akun users')); ?></div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row mb-3">
                                <label for="lembaga"
                                    class="col-md-4 col-form-label text-md-end"><?php echo e(__('Lembaga')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row mb-3">
                                <label for="surat_keterangan"
                                    class="col-md-4 col-form-label text-md-end"><?php echo e(__('Surat Keterangan')); ?></label>
                                <div class="col-md-6">
                                    <input type="file" name="surat_keterangan" id="surat_keterangan"
                                        class="form-control <?php $__errorArgs = ['surat_keterangan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        autocomplete="surat_keterangan" autofocus value="<?php echo e(old('surat_keterangan')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <a href="<?php echo e(route('login')); ?>" class="text-center" target="_blank">sudah
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mjcutter/stagging-sipp.mjcutter.com/resources/views/auth/register.blade.php ENDPATH**/ ?>